...
function App() {
  ...
  return (
    <div className="App">
      {/* <ButtonWithImage onClick={() => {}} src={imgSrc} />
      <ButtonWithText onClick={() => {}} text="hello" />
      <ButtonWithElement
        onClick={() => {}}
        element={<div style={{ fontWeight: "bolder" }}>Hello there</div>}
      /> */}
      <Button onClick={() => {}}>
        <div style={{ fontWeight: "bolder" }}>Hello there</div>
      </Button>

      <Button onClick={() => {}}>
        <img src={imgSrc} alt="button" width="70px" />
      </Button>
      {/* <ChatList /> */}
      <div>
